...
-- Disable mouse mode, it's enabled by default.
vim.opt.mouse = ''

-- Don't show the mode, since it's already in the status line
vim.opt.showmode = false

-- Don't wrap around lines
vim.opt.wrap = false
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>p', fzf.files, { desc = 'Search files' })
      vim.keymap.set('n', '<C-f>', fzf.grep, { desc = 'Search by grep' })
...

  {
    ...
    keys = {
      ...
      { '<leader>cS', '<cmd>ClaudeCodeStart<cr>', desc = 'Start Claude' },
